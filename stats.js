...
Promise.map(urlList, function(url) {
    ...
    toWrite += '</center></div><a class="browse-bottom" href="https://knowledgebrowser.org/preprints/last-week"  onClick="gtag_report_conversion()"><small>browse...</small></a></div></div></div></div></div>';
    ...
    toWrite += '<div class="row" style="padding-bottom:1.5rem"><div class="col-12 col-md-9"><p class="log-name">new feature</p><div class="log-details">popular term monitoring has been implemented</div></div><div class="col-12 col-md-3"><small class="log-time">3rd June 2019</small></div></div>';
